...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return get_loader(self.train_data, self.batch_size // self.num_gpus, self.num_workers, self.n_classes,
    ...
    def val_dataloader(self):
        return DataLoader(self.test_data, batch_size=250, num_workers=self.num_workers, shuffle=False)
